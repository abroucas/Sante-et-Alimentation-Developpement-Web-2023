...
<?php
            ...
            <div class="entree_repas">
                ...
                <form action="#">
                    ...
                    <div class="fil-actualite-voir-plus-container">
                        <button class="fil-actualite-voir-plus" id="bouton" onclick="dupliquer1()">+</button>
                    </div>
                    <div class="button">
                        <input type="submit" value="Enregistrer">
                    </div>
            ...
            <div class="entree_repas">
                ...
                <form action="#">
                    <div class="repas" id="repas2">
                     ...
                     <div class="fil-actualite-voir-plus-container">
                        <button class="fil-actualite-voir-plus" id="bouton" onclick="dupliquer2()">+</button>
                    </div>
                    <div class="button">
                        <input type="submit" value="Enregistrer">
                    </div>
            ...
            <div class="entree_repas">
                ...
                <form action="#">
                    <div class="repas" id="repas3">
                     ...
                     <div class="fil-actualite-voir-plus-container">
                        <button class="fil-actualite-voir-plus" id="bouton" onclick="dupliquer3()">+</button>
                    </div>
                    <div class="button">
                        <input type="submit" value="Enregistrer">
                    </div>
    ...
    <script>
             ...
             function dupliquer1(){
                 ...
                 // Récupérer la division repas
                 var repas = document.getElementById("repas1");
                 
                 // Cloner la division repas
                 var clone = repas.cloneNode(true);
                 

                 // ajouter la nouvelle division repas après la division repas initiale
                 
                 insertAfter(clone,repas);
             ...
             function dupliquer2(){
                 ...
                 // Récupérer la division repas
                 var repas = document.getElementById("repas2");
             ...
             function dupliquer3(){
                 ...
                 // Récupérer la division repas
                 var repas = document.getElementById("repas3");
